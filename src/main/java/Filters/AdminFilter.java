...
@WebFilter(filterName="AdminFilter", urlPatterns={"/AddMovieServlet",
		"/DeleteMovieServlet", "/EditMovieServlet", "/GetMovieList",
		"/admin/AddMovie.jsp","/admin/AdminHome.jsp", "/admin/EditMovie.jsp",
		"/admin/ListMovies.jsp"})
